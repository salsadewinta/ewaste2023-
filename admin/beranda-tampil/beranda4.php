         ...
         <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              ?>
              <div class="info-box-content">
                <span class="info-box-text">Data Kompos</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              ?>
              <div class="info-box-content">
                <span class="info-box-text">Antar Jemput</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              ?>
              <div class="info-box-content">
                <span class="info-box-text">ECommerce</span>
               ...
               <!-- /.col -->
                <div class="col-md-12">
                  ...
                  <div class="card card-widget widget-user-2">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text"><h3>Transaksi</h3></span>
                    </div>
                    </div>
                    </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-widget widget-user-2">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text"><h3>Data Master</h3></span>
                    </div>
                    </div>
                    </div>
                    <div class="col-12 col-sm-12">
                      ...
                      ?>
                        ...
                        <li class="nav-item">
                          <a href="#" class="nav-link">
                           Petuugas <span class="float-right badge bg-info"><?=$data14;?></span>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="#" class="nav-link">
                          <span class="float-right badge bg-success"></span>
                          </a>
                        </li>
                      </ul>
                    </div>
