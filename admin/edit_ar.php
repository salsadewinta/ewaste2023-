      ...
      <div class="container-fluid">
        ...
        <div class='form'><form method='post' action='update_ar.php' class='cmxform form-horizontal tasi-form' id='commentForm'>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="id_antar" class="form-control" size="4" value="<?php echo $data['id_antar']; ?>" readonly="readonly" required>
            </div>
            </div>
          <div class='form-group'>
            <label for='cname' class='control-label col-lg-2'>KONFIRMASI</label>
            <div class='col-lg-10'>
