...
<ul class="navbar-nav ml-auto">
 ...
 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">DATA KOMPOS</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
   ...
   <!-- Main content -->
    ...
    <br><br>
    <form action="update_kompos.php" method="post" enctype="multipart/form-data">
      <div class="form-group row">
      <div class="form-group row">
        <div class="col-sm-10">
          <input type="number" name="id_kompos" class="form-control" value="<?php echo $data->id_kompos; ?>" hidden>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <textarea name="deskripsi" class="form-control" value="<?php echo $data->deskripsi; ?>">
          </textarea>
        </div>
      </div>
      <div class="form-group row">
          ...
          <div class="col-sm-10">
          <img src="kompos/<?php echo $data->gambar; ?>" width="100">
          <input type="text" name="foto" value="<?php echo $data->gambar?>">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <a href="kompos.php" class="btn btn-warning">KEMBALI</a>
        </div>
      </div>
    </form>
        </div>
