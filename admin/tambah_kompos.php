...
<ul class="navbar-nav ml-auto">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <div class='form'><form method='post' action='simpan_kompos.php' enctype="multipart/form-data" class='cmxform form-horizontal tasi-form' id='commentForm'>
      ...
      <div class='form-group'>
        ...
        <a class='btn btn-danger' href='kompos.php'>Batal</a>
        </div>
      </div>
    </form>
        </div>
