  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class='form'><form method='post' action='simpan_fk.php' class='cmxform form-horizontal tasi-form' id='commentForm'>
          <div class="form-group ">
            <label for="id_kompos" class="control-label col-lg-2">ID KOMPOS</label>
            <div class="col-lg-10">
              <select class="form-control" name="id_kompos" required >
                <option>-ID KOMPOS-</option>
                  <?php
