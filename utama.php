    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 ms-auto me-auto p-lg-2 mt-lg-2 mt-2">
        <div class="row justify-content-start">
          <p class="pe-1">ELectronic Waste (E-Waste) merupakan sistem informasi berbasis web yang berada dalam bidang lingkungan dengan dilengkapi fitur antar jemput sampah serta e-commerce kompos.
...
<section class="my-1 py-1">
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 ms-auto me-auto p-lg-2 mt-lg-2 mt-2">
        <div class="row justify-content-start">
          <p class="pe-1">Pasar Gedebage merupakan salah satu pasar induk terbesar di Kota Bandung dengan luas bangunan mencapai 14.536 meter persegi.
      ...
      <div class="col-lg-6 ms-auto">
        ...
        <div class="row justify-content-start">
          <div class="col-md-6">
            <div class="info">
              ...
              <p class="pe-5">Kini hadir antar jemput sampah online yang bisa diakses di website E-Waste serta sudah dapat di akses oleh user.</p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="info">
              ...
              <p class="pe-3">Setelah sampah sudah sampai, tim E-waste akan melakukan pendaur ulangan sampah. Untuk Limbah makanan akan diubah menjadi kompos, untuk sampah plastika akan diuraikan dan sisanya akan dibuat olahan kerajinan tangan </p>
            </div>
          </div>
        </div>
        <div class="row justify-content-start mt-1">
          <div class="col-md-6 mt-3">
            ...
            <p class="pe-5">Koin dapat didapatkan dari hasil antar jemput sampah. Selain itu Koin dapat ditukarkan dengan produk kompos yang tersedia di halaman e-commerce pada website E-Waste.</p>
          </div>
        </div>
      </div>
    </div>
