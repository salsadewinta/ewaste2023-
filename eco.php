...
<header class="header-2">
  <div class="page-header min-vh-75 relative" style="background-image: url('./assets/img/11111.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 text-center mx-auto">
          <h1 class="text-white pt-3 mt-n5">E-Commerce</h1>
          <p class="lead text-white mt-3">Tukarkan koinmu yang didapat dari transaksi penjemputan sampah dengan kompos yang tersedia di website E-Waste</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="my-1 py-1">
  <br>
  <div class="container">
    <h2 class="font-weight-bolder mt-6 text-center">Apa itu fitur E-Commerce?</h2><br>
    <div class="row align-items-center">
      <div class="col-lg-4 ms-auto">
        <img src="assets/img/leaf2.png" class="d-block w-100" alt="...">
      </div>
      <div class="col-lg-6 ms-auto me-auto p-lg-2 mt-lg-2 mt-2">
        <div class="row justify-content-start">
          <p class="pe-1">
            Fitur E-Commerce adalah fitur jual beli kompos yang berada dalam website E-Waste. Fitur ini membantu masyarakat untuk melakukan penghijauan dan memelihara lingkungan dengan cara membeli produk kompos yang tersedia di website E-Waste.
            Dan harga produk kompos yang tersedia pada website E-Waste ini sangat terjangkau dan terjamin kualitasnya.
          </p>
      </div>
    </div>
...
<section class="my-1 py-1">
  <br>
  <div class="container">
    <h2 class="font-weight-bolder mt-6 text-center">Tatacara Bertransaksi Pada Fitur E-Commerce</h2><br>
    <div class="row align-items-center">
      <div class="col-lg-6 ms-auto me-auto p-lg-2 mt-lg-2 mt-2">
        <div class="row justify-content-start">
          <p class="pe-1">
            Berikut disertakan langkah-langkah dalam membeli produk kompos di website E-Waste :
            <p>1. Mengakses halaman website E-Waste pada browser</p> 
            <p>2. Memasuki halaman Register/Login</p> 
            <p>3. Memasukkan informasi akun (Login apabila sudah memiliki akun, dan Register apabila belum memiliki akun)</p> 
            <p>4. Menekan fitur E-Commerce yang tersedia pada halaman beranda</p> 
            <p>5. Memilih produk kompos yang tesedia pada halaman website</p> 
            <p>6. Memasukkan jumlah barang yang akan dibeli</p> 
            <p>7. Mengonfirmasi pembelian produk kompos</p> 
            <p>8. Melakukan pembayaran produk</p>
            <p>9. Menunggu kompos diantar ke alamat yang di tuju</p> 
          </p>
      </div>
    </div>
      <div class="col-lg-4 ms-auto">
        <img src="assets/img/homepage.png" class="d-block w-100" alt="...">
      </div>
  </div>
</section>
...
<section class="my-5 py-5">
  <br>
  <div class="container">
    <h2 class="font-weight-bolder mt-3 text-center">Alur Melakukan Penjemputan di website E-Waste</h2><br>
    <div class="row align-items-center">
      <center>
      <div class="col-lg-4s">
        <img src="assets/img/homepage.png" class="d-block w-100" alt="..." width="35">
      </div></center>
    </div>
  </div>
</section>
