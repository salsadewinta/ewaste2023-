    ...
    <section class="content">
          ...
          <div class="col">
            ...
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#ar" data-toggle="tab">Antar Jemput</a></li>
                  <li class="nav-item"><a class="nav-link" href="#ec" data-toggle="tab">E-commerce</a></li>
                </ul>
              </div>
          <!-- /.card-header -->
              <div class="card-body">
              <div class="tab-content">
                  <div class="active tab-pane" id="ar">
      ...
      <tbody>
       ...
       //query ke database SELECT tabel tb_member urut berdasarkan id yang paling besar
        $sql = mysqli_query($kon, "SELECT * FROM antar_jemput Where pesanan='delay' AND id_user = '$id_user'") or die(mysqli_error($kon));
