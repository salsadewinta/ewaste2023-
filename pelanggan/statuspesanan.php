              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    Sistem kami telah menerima ordermu
                  </div>
                </div>
              </div>
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    Sistem kami sedang memproses ordermu
                  </div>
                </div>
              </div>
            <div>
                <i class="fas fa-envelope bg-green"></i>
                <div class="timeline-item">
                    <h3 class="timeline-header">Barang dikemas</h3>
                    
                    <div class="timeline-body">
                        Petugas kami sedang menyiapkan produk yang kamu pesan
                    </div>
                </div>
            </div>
            <div>
                <i class="fas fa-envelope bg-green"></i>
                <div class="timeline-item">
                    <h3 class="timeline-header">Barang diantar</h3>
                    
                    <div class="timeline-body">
                        Petugas kami sedang mengantarkan produk yang kamu pesan
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-body">
                        Barang telah sampai di lokasimu
                    </div>
                </div>
            </div>

            <center><div class="card-footer">
              <a href="homepage1.php" class="btn btn-success" role="button"> Order Selesai</a>
              <a href="homepage1.php" class="btn btn-danger" role="button"> Order Batal</a>
            </div></center>
        </div>
    </div>
</div>
