  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="orderlinejemput.html" class="nav-link">Antar_Jemput</a>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    Sistem kami sedang memproses order sampahmu
                  </div>
                </div>
              </div>
            <div>
                <i class="fas fa-envelope bg-green"></i>
                <div class="timeline-item">
                    <h3 class="timeline-header">Penjemputan Sampah</h3>
                    
                    <div class="timeline-body">
                        Petugas kami sedang dalam perjalanan untuk mengangkut sampahmu
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-body">
                        Sampahmu telah berhasil diverifikasi oleh petugas kami
                    </div>
                </div>
            </div>

            <center><div class="card-footer">
              <a href="homepage.html" class="btn btn-success" role="button"> Order Selesai</a>
              <a href="antarjemput.html" class="btn btn-danger" role="button"> Order Batal</a>
            </div></center>
